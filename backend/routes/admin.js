...
// POST /api/admin/login - Step 1: Email + Password, sends OTP
...
// POST /api/admin/verify-otp - Step 2: Verify OTP, return JWT
...
// POST /api/admin/create - Create admin user (for initial setup)
router.post('/create', async (req, res) => {
    try {
        const { email, password, setupKey } = req.body;

        // Simple setup key for initial admin creation
        if (setupKey !== 'AZENTERPRISES2024') {
